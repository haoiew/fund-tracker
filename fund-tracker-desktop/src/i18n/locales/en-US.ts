export default {
  ...
  about: {
    ...
    features: {
      ...
      ocr: {
        ...
        desc: 'Intelligently recognize fund screenshots'
      },
      alert: {
        title: 'Price Alerts',
  ...
  ocr: {
    title: 'OCR Recognition',
    tip: 'Upload fund screenshot to auto-recognize fund codes',
    dragTip: 'Drag image here or click to upload',
    supportFormat: 'Support JPG, PNG, GIF, max 10MB',
    selectFile: 'Select File',
    processing: 'Processing...',
    startRecognize: 'Start Recognition',
    result: 'Recognition Result',
    foundFunds: 'Found {count} funds',
    extractedFunds: 'Extracted Funds',
    confidence: 'Confidence',
    rawText: 'Raw Text',
    noFundsFound: 'No fund information recognized',
    pleaseUploadImage: 'Please upload an image first',
    recognizeSuccess: 'Recognition successful, found {count} funds',
    ...
    fundAlreadyExists: 'This fund is already in the watchlist',
    addSuccess: 'Added {name} to watchlist',
    addFailed: 'Add failed',
    howToUse: 'How to Use',
    step1: 'Upload Screenshot',
    step2: 'Auto Recognize',
    step3: 'View Results'
  },
  fund: {
