export default {
  ...
  ocr: {
    title: 'OCR识别',
    tip: '上传基金截图，自动识别基金代码',
    dragTip: '拖拽图片到此处，或点击上传',
    supportFormat: '支持 JPG、PNG、GIF 格式，最大 10MB',
    selectFile: '选择文件',
    processing: '识别中...',
    startRecognize: '开始识别',
    result: '识别结果',
    foundFunds: '找到 {count} 只基金',
    extractedFunds: '提取的基金',
    confidence: '置信度',
    rawText: '原始识别文本',
    noFundsFound: '未识别到基金信息',
    pleaseUploadImage: '请先上传图片',
    recognizeSuccess: '识别成功，找到 {count} 只基金',
    recognizeFailed: '识别失败，请重试',
    invalidFileType: '请上传图片文件',
    fileTooLarge: '文件大小不能超过10MB',
    fundAlreadyExists: '该基金已在关注列表中',
    addSuccess: '已添加 {name} 到关注列表',
    addFailed: '添加失败',
    howToUse: '使用说明',
    step1: '上传截图',
    step2: '自动识别',
